package com.example.wazitoecommerce.ui.theme.screens.nakurubooking
...
@Composable
fun NakuruBookingScreen(navController: NavHostController) {
...
@Composable
fun NakurubookingScreenPreview(){
    NakuruBookingScreen(rememberNavController())
}
