package com.example.wazitoecommerce.ui.theme.screens.malindibooking
...
@Composable
fun MalindiBookingScreen(navController: NavHostController) {
...
@Composable
fun MalindibookingScreenPreview(){
    MalindiBookingScreen(rememberNavController())
}
