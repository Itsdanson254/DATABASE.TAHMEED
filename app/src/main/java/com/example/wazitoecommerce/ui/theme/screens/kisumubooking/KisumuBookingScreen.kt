package com.example.wazitoecommerce.ui.theme.screens.kisumubooking
...
@Composable
fun KisumuBookingScreen(navController: NavHostController) {
...
@Composable
fun KisumubookingScreenPreview(){
    KisumuBookingScreen(rememberNavController())
}