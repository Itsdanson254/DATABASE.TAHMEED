package com.example.wazitoecommerce.ui.theme.screens.naivashabooking
...
@Composable
fun NaivashaBookingScreen(navController: NavHostController) {
    Column(modifier = Modifier.fillMaxSize()) {

        //Top app bar
        TopAppBar(
            title = { Text(text = "TAHMEED BOOKIMG ") },
        )
        //end of Top app bar
...
@Composable
fun NaivashabookingScreenPreview(){
    NaivashaBookingScreen(rememberNavController())
}
