package com.example.wazitoecommerce.ui.theme.screens.mombasabooking
...
@Composable
fun MombasaBookingScreen(navController: NavHostController) {
...
@Composable
fun MombasabookingScreenPreview(){
    MombasaBookingScreen(rememberNavController())
}
